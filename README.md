...
from the knee sweep at admission cap 256, not from the two boots at cap 32, which
disagree by 1.46x at that level — see the recipe. c=16 is this model's throughput
**peak**, not a mid-sweep point — aggregate falls to 667 tok/s at c=32,
